import type { BatchRecord, PromotionRecord, WorkflowPlan } from "../types/index.js";
...
export function formatBatchCompletion(batch: BatchRecord): string {
  ...
  const lines = [
    ...
    "",
    "TASK  STATUS  DEPENDENCIES  MODE  ATTEMPTS  DURATION  SCORE"
  ];
