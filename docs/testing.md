...
- benchmark tests cover strict v5 rubrics, blind packets, untrusted embedded instructions, evidence exclusions, all failure-policy actions, judge protocol failures, score intervals, provenance, record/report separation, exit precedence, and confirmation that ordinary runs never launch the judge;
